...
def get_geo_area_best_days_hours_service_for_books(lat, long, km_radius):
    ...
    query ="SELECT COUNT(*) as reservations, t.day_of_week, t.hour, sr.name " \
          "FROM `books` b " \
          ...
          "GROUP BY t.day_of_week, t.hour, sr.service_id " \
...
#print(get_geo_area_best_days_hours_service_for_books(40.5913901, 17.10919, 10))
